...
class Model(object):
  ...
  def build_model(self, x_input):
    ...
    with tf.variable_scope('unit_1_0'):
      res_block10 = res_func(x, filters[0], filters[1], self._stride_arr(strides[0]),
                   activate_before_residual[0])
    with tf.variable_scope('unit_1_1'):
      res_block11 = res_func(res_block10, filters[1], filters[1], self._stride_arr(1), False)
    with tf.variable_scope('unit_1_2'):
      res_block12 = res_func(res_block11, filters[1], filters[1], self._stride_arr(1), False)
    ...
    with tf.variable_scope('unit_2_2'):
      res_block22 = res_func(res_block21, filters[2], filters[2], self._stride_arr(1), False)
    ...
    with tf.variable_scope('unit_3_2'):
      res_block32 = res_func(res_block31, filters[3], filters[3], self._stride_arr(1), False)
